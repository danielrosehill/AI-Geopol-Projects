#!/usr/bin/env python3
"""
Update script for AI Geopolitical Projects index.
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Manage AI Geopolitical Projects index")
    parser.add_argument("--update", action="store_true", help="Update metadata and optionally fetch from GitHub")
    parser.add_argument("--fetch-github", action="store_true", help="Fetch latest information from GitHub API")
    parser.add_argument("--add", metavar="REPO_URL", help="Add a new project by GitHub URL")
    parser.add_argument("--category", help="Category for new project (required with --add)")
    parser.add_argument("--description", help="Description for new project (optional with --add)")
